...
import { getTemplates, sendSignableMail } from "../../actions/mailActions";
...
class SignableMail extends Component {
  constructor(props) {
    super(props);
    this.state = {
      templates: "",
  ...
  onSubmit(e) {
    ...
    this.props.sendSignableMail(mailData, this.props.history);
  }
          ...
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <h1 className="display-4 text-center">
                Email Vertrag Unterschriftsbereit
              </h1>
              <hr />
